...
public class PlayerDetails extends Scene   {
	...
	Label title, player1TitleLabel, player1NameLabel, player1Difficulty, player1StartLocation;
	...
	public void drawPlayer1Info()
	{
		...
		player1NameLabel = new Label(this, player1LabelText, Label.genericFont(Color.GRAY, 40));
		player1NameLabel.setText("Name");
		player1NameLabel.setPosition(36, 510);
	...
	public void setDifficultyPlayer1(LabelButton label)
	{
		...
		currentDifficultyPlayer1.setColor(Color.GRAY);
	...
	{
		System.out.println("Difficulty set:" + label.getText());
		currentDifficultyPlayer2.setColor(Color.GRAY);
	...
	public void startCityPlayer1(LabelButton label) {
		prevStartCityPlayer1.setColor(Color.GRAY);
		label.setColor(Color.BLUE);
	...
	public void startCityPlayer2(LabelButton label) {
		prevStartCityPlayer2.setColor(Color.GRAY);
		label.setColor(Color.RED);
