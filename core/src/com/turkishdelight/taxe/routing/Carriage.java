...
public class Carriage extends SpriteComponent {
	...
	public Carriage(int width, int height, int weight, Scene parentScene, Texture text, int z, Path path, SpriteComponent carriage) {
	...
	private void updatePosition() {
		...
		crs.derivativeAt(out, current);
		current += speed*30/out.len();    // 30 is just an arbitrary number, works well- increase to increase distance travelled each turn
